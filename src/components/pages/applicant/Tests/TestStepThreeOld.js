...
function TestStepThree() {
  ...
  return (
    <div>
      {/* {hasStartedTest && (
        <AppTimer redux_timer={app_timer} timeDuration={focusedTest.duration} />
      )} */}
                            ...
                            focusedSkill.gorilla_link !== null ? (
                              <div className="mb-5">
                                ...
                                <p>
                                  ...
                                  You'd be taking the test on the external site, TestGorilla.
                                </p>

                                <>
                                  <div className="alert alert-info">
                                  Be notified that by clicking the 'Redirect me' button below will send you to the TestGorilla website.
                                    <br></br>
