    ...
    <div id="terms_of_use" 
     style={{marginTop:80}}> 
      ...
      <p>
        ...
        and (&quot;Company,&quot; &ldquo;we,&quot; &ldquo;us,&quot; or
        &ldquo;our&rdquo;), concerning your access to and use of the newton.com
        ...
        (collectively, the &ldquo;Site&rdquo;). You agree that by accessing the
        ...
        &ldquo;Last updated&rdquo; date of these Terms of Use, and you waive any
        right to receive specific notice of each such change. Please ensure that
        you check the applicable Terms every time you use our Site so that you
        ...
        this Site. You may not use the Site in a way that would violate the
        Gramm-Leach-Bliley Act (GLBA). The Site is intended for users who are at
      ...
      <p>
        ...
        laws of the United States, international copyright laws, and
        international conventions. The Content and the Marks are provided on the
        Site &ldquo;AS IS&rdquo; for your information and personal use only.
      ...
      <p>
        ...
        endorsed or approved by us. As a user of the Site, you agree not to: use
        a bot to collect any information from the Site;&nbsp;Systematically
        ...
        limitation, clear graphics interchange formats (&ldquo;gifs&rdquo;),
        1&times;1 pixels, web bugs, cookies, or other similar devices (sometimes
        referred to as &ldquo;spyware&rdquo; or &ldquo;passive collection
        mechanisms&rdquo; or &ldquo;pcms&rdquo;). Interfere with, disrupt, or
        create an undue burden on the Site or the networks or services connected
        to the Site. Harass, annoy, intimidate, or threaten any of our employees
        ...
        Site&rsquo;s software, including but not limited to Flash, PHP, HTML,
      ...
      <p>
        ...
        account, a &ldquo;Third-Party Account&rdquo;) by either: (1) providing
        ...
        to and stored in your Third-Party Account (the &ldquo;Social Network
        Content&rdquo;) so that it is available on and through the Site via your
      ...
      <p>
        ...
        facilitate the proper functioning of the Site. 11. PRIVACY POLICY We
        care about data privacy and security. Please review our Privacy Policy:
        https:privacy.com. By using the Site, you agree to be bound by our
        Privacy Policy, which is incorporated into these Terms of Use. Please be
        advised the Site is hosted in Nigeria. If you access the Site from any
        ...
        laws in Nigeria, then through your continued use of the Site, you are
        transferring your data to Nigeria, and you agree to have your data
        transferred to and processed in Nigeria. Further, we do not knowingly
      ...
      <p>
        ...
        Nigeria. You irrevocably consent that the courts of Nigeria shall have
      ...
      <p>
        ...
        place, of arbitration shall be Lagos, Nigeria. The language of the
        proceedings shall be English. The governing law of the contract shall be
        the substantive law of Nigeria. Restrictions The Parties agree that any
        ...
        behalf of the general public or any other persons. Exceptions to
        Informal Negotiations and Arbitration The Parties agree that the
        following Disputes are not subject to the above provisions concerning
        informal negotiations and binding arbitration: (a) any Disputes seeking
      ...
      <p>
        ...
        representations about the accuracy or completeness of the site&rsquo;s
      ...
      <p>
        ...
        the Site or with respect to the Site constitute the entire agreement and
      ...
      <p>
        ...
        information regarding the use of the Site, please contact us @&nbsp;
        <a href="mailto:newton@newtoncore.com">newton@newtoncore.com</a>&nbsp;
      </p>
    </div>
  );
}

export default TermsOfUseDoc;